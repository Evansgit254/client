      ...
      >
        ...
        >
          ...
          <Form.Item
            ...
            label="Country"
            rules={[
              { required: true, message: "Please enter the house country" },
            ]}
          >
            <Input />
          </Form.Item>
          ...
          <Form.Item
            ...
            label="City"
            rules={[
              { required: true, message: "Please enter the house city" },
            ]}
          >
            <Input />
          </Form.Item>
          ...
          <Form.Item
            ...
            label="Price"
            rules={[
              { required: true, message: "Please enter the house price" },
            ]}
          >
            <Input />
          </Form.Item>
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Please select the advert type",
              },
            ]}
          >
            <Select>
